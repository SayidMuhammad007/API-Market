...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/company/{company}/stores', [CompanyController::class, 'stores']);
    ...
    Route::post('/product/add', [StoreController::class, 'updateQty']);
    ...
    Route::get('/statistics/kassa', [StatisticController::class, 'allStat']);
